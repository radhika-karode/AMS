...
// This mail is working here
$ms.="<div style='padding-top:8px;font-weight:bold'>Your child on $attdate in shift $shift was $attvalue. 
</div><div</body></html>";
...
<div class="col-md-6 mt-10">
<select class="form-control" name="shift" required="required"style="background-color: #282B34;color:white">
